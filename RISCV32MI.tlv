...
\SV
   ...
   m4_asm(REM, x14, x12, x13)           // Incremental summation
...
\TLV
   ...
   //I-Type instructions
   $is_addi = $dec_bits ==? 11'bx_000_0010011 && $funct7[0] == 1'b0;
   ...
   //R-Type instructions
   $is_add = $dec_bits == 11'b0_000_0110011 && $funct7[0] == 1'b0;
   ...
   $is_or = $dec_bits == 11'b0_110_0110011 && $funct7[0] == 1'b0;
   $is_and = $dec_bits == 11'b0_111_0110011;
   $is_mul = ($dec_bits == 11'b0_000_0110011 && $funct7 == 7'd1);
   $is_mulh = ($dec_bits == 11'b0_001_0110011 && $funct7 == 7'd1);
   $is_mulhu = ($dec_bits == 11'b0_011_0110011 && $funct7 == 7'd1);
   $is_mulhsu = ($dec_bits == 11'b0_010_0110011 && $funct7 == 7'd1);
   $is_div = ($dec_bits == 11'b0_100_0110011 && $funct7 == 7'd1);
   $is_divu = ($dec_bits == 11'b0_101_0110011 && $funct7 == 7'd1);
   $is_rem = ($dec_bits == 11'b0_110_0110011 && $funct7 == 7'd1);
   $is_remu = ($dec_bits == 11'b0_111_0110011 && $funct7 == 7'd1);
